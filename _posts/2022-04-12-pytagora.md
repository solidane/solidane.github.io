...
- $$3 \times 3$$ for the height (side)
- $$4 \times 4$$ for the width (side)
- $$5 \times 5$$ for the hypotenuse 
...
where $$a$$ and $$b$$ represent the cathetuses, otherwise known as the legs adjacent or opposite-sided of the right angle and $$c$$s is the hypotenuse.