...
contributed to many fields such as music, philosophy, astronomy and mathematics, the latter including the famous Pythagorean theorem.
...
### Try it yourself
Play around with <math display="inline"><mi>a</mi></math> and <math display="inline"><mi>b</mi></math> to see that this theorem holds. See how the forms slide into eachother, which shows why these areas are of equal size.
